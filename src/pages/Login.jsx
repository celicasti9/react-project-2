              ...
              <form>
                ...
                <div>
                  <label className="inline-flex items-center cursor-pointer">
                    ...
                    <span className="ml-2 text-sm font-semibold text-blueGray-600">Remember </span>
                  </label>
                </div>
                <div className="text-center mt-6">
                  <button className="bg-blueGray-800 text-blueGray-600 active:bg-blueGray-600 text-sm font-bold uppercase px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 w-full ease-linear transition-all duration-150" type="button"> Sign In </button>
                </div>
              </form>
            </div>
          </div>
